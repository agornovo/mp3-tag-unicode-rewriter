...
public class MP3File extends java.io.File
{
     ...
     *
     * @return Initial key
     * @exception FrameDamagedException If frame is damaged (for example, too short)
     */
    ...
    /**
     * Read part of a set (for example, 1/2 for a double CD), store as text content
     *
    ...
    /**
     * Set part of a set (for example, 1/2 for a double CD), read from text content.
     *
     ...
     * for example, for movie soundtracks, then points to the movie
     *
