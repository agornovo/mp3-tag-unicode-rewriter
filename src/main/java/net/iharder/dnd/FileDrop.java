 ...
 * system to a Java program. Any <code>java.awt.Component</code> can be
 * dropped onto, but only <code>javax.swing.JComponent</code>s will indicate
 * the drop event with a changed border.
 * </p>
 * <p>
 * To use this class, construct a new <code>FileDrop</code> by passing
 * it the target component and a <code>Listener</code> to receive notification
 ...
 * object (such as <code>System.out</code>) into the full constructor. A <code>null</code>
...
public class FileDrop
{
     ...
     * If your component is a <code>java.awt.Container</code>, then each of its children
     ...
     * <code>System.out</code> or <code>System.err</code>. A <code>null</code> value for
     * the parameter <code>out</code> will result in no debugging output.
     *
     ...
     *
     * @param c Component on which files will be dropped.
     * @param dragBorder Border to use on <code>JComponent</code> when dragging occurs.
     * @param listener Listens for <code>filesDropped</code>.
     * @since 1.0
     */
    public FileDrop(
                ...
                {   log( out, "FileDrop: drop event." );
                    ...
                    {   // Get whatever was dropped
                        ...
                        if (tr.isDataFlavorSupported (java.awt.datatransfer.DataFlavor.javaFileListFlavor))
                        {
                            ...
                            // Get a useful list
                            java.util.List<String> fileList = (java.util.List<String>) 
...
/* ********  I N N E R   I N T E R F A C E   L I S T E N E R  ******** */    
    ...
    public static interface Listener {
         ...
         *
         * @param files An array of <code>File</code>s that were dropped.
         * @since 1.0
         */
...
/* ********  I N N E R   C L A S S  ******** */
    ...
    public static class TransferableObject implements java.awt.datatransfer.Transferable
    {
         ...
         * {@link TransferableObject} has the representation class
         * <code>net.iharder.dnd.TransferableObject.class</code>
         * and the MIME type 
         * <code>application/x-net.iharder.dnd.TransferableObject</code>.
         *
         * @since 1.1
         ...
         * with the encapsulated object or <code>null</code> if the {@link Fetcher}
